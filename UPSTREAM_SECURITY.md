> **Note (Chaintable):** This is the security policy of upstream
> [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum), preserved as-is
> in this fork. It applies to issues in the upstream chain client. For issues in
> this fork's Chaintable additions, see [SECURITY.md](./SECURITY.md). Canonical,
